 ...
 * @param string $text_color (optional) one of: black, red, green, yellow, blue, magenta, cyan
 * @param string $bg_color (optional) one of: black, red, green, yellow, blue, magenta, cyan
 */
